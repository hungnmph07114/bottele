...
const tf = require('@tensorflow/tfjs'); // Giữ nguyên phiên bản browser để tránh lỗi
...
*Lưu ý*:  
- Bot sử dụng AI (TensorFlow.js) và chỉ báo kỹ thuật (RSI, MACD, ADX, Bollinger Bands) để phân tích.  
